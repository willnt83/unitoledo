...
function getEntityMarkup(entityMap, entityKey, text, customEntityTransform) {
  ...
  if (entity.type === 'IMAGE') {
    ...
    //--Will
    //Alteração feita para envelopar as imagens em um <p> para conseguir centralizá-las qdo o usuário selecionar alinhamento = centro (float: none)
    return '<p style="text-align: center"><img src="' + entity.data.src + '" alt="' + entity.data.alt + '" style="float:' + (entity.data.alignment || 'none') + ';height: ' + entity.data.height + ';width: ' + entity.data.width + '"/></p>';
  }
