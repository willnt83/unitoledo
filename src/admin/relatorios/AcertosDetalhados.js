...
class AcertosDetalhados extends Component {
    constructor(props) {
        super()
		props.setPageTitle('Relatório Detalhado por Acertos')
    }
...
export default connect(MapStateToProps, mapDispatchToProps)(Form.create()(withRouter(AcertosDetalhados)))