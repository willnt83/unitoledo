...
class HabilidadesConteudos extends Component {
	constructor(props) {
        super()
	...
	gerarRelatorio = () => {
		this.props.form.validateFieldsAndScroll((err, values) => {
			if(!err){
				this.setState({
					buttonLoading: false,
					reportUrl: this.props.backEndPoint+'/api/relatorioHabilidadeEConteudo/'+values.simulado
				})
			}
		})
	}
...
export default connect(MapStateToProps, mapDispatchToProps)(Form.create()(withRouter(HabilidadesConteudos)))